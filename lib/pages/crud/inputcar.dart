...
class _InputPageState extends State<InputPageCar> {
  ...
  TextEditingController _ctrlPemesanan1 = TextEditingController();
              ...
              children: [
                ...
                Row(
                  children: [
                    Radio(
                      value: 'Car M',
                      groupValue: Pemesanan1,
                      onChanged: (value) {
                        setState(() {
                          Pemesanan1 = value!;
                          _ctrlPemesanan1.text = "Car M" ;
                        });
                      },
                    ),
                    Text('Car M'),
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    try {
                      ...
                      // });
                      // Pemesanan1 = selectedCategoryList.join(
                      //     ', '); // Combine selected categories into a string

                      // Simpan data ke Firestore
                      await inputcar.add({
                        'nama': _ctrlName.text,
                        'Kategori Mobil': _ctrlPemesanan1.text,
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                Text('Nama Anda: $name'),
                                Text('Kategori Mobil: $Pemesanan1'),
